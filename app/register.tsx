      ...
      <View style={styles.container}>
        ...
        <View style={styles.form}>
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} placeholder="Seu nome" placeholderTextColor="#999" value={name} onChangeText={setName} />
          </View>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} placeholder="Crie uma senha" placeholderTextColor="#999" value={password} onChangeText={setPassword} secureTextEntry />
          </View>
